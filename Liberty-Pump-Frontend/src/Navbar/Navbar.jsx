...
export const Navbar = ({ products, categories }) => {
    ...
    let navbarClasses = `
        ...
        ${scrolled || isDashboard ? 'fixed w-full    top-0 z-50 bg-white  text-orange-500 shadow-lg' : 'bg-white  max-w-[1340px] rounded-lg'}
    `;

    const activeBorder = "border-b-2 border-orange-500 ";
    ...
    return (
        <div className='relative z-10  ' >
                ...
                <div className='flex justify-between mx-auto items-center max-w-[1340px]'>
                    ...
                    <div className="flex items-center justify-center space-x-4">
                        <div className="space-x-5 md:hidden">
                            {admin && isDashboard && (
                                <label
                                    ...
                                    className="drawer-button text-orange-500 text-xl lg:hidden"
                                >
                                    ☰
                                </label>
                            )}
                        ...
                        <div className='cursor-pointer block' onClick={() => navigate('/')}>
                            {logo ?
                                // ? 
                                // <p className='text-3xl text-orange-500 font-semibold'>Air <span className='text-orange-500'>Wheeler</span></p>
                    ...
                    <div className="hidden lg:flex">
                        <ul className="menu menu-horizontal px-1 text-md font-semibold">
                            ...
                            <li className={`${linkText} ${location.pathname === "/catelog" ? activeBorder : ""}`}>
                                <Link className={linkText} to="/catelogue">Catelogue</Link>
                            </li>
                            {
                                admin && (
            ...
            {showMegaBar && (
                <div
                    ref={megaBarRef}
                    className="bg-white backdrop-blur-xs w-full transition-all duration-300 hidden md:block max-w-[1340px] mx-auto left-1/2 transform -translate-x-1/2 fixed top-[55px] shadow-2xl shadow-blue-300 rounded-lg z-50"
                >
