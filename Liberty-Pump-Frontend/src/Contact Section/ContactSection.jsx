    ...
    return (
        <section   className="overflow-x-hidden" >
            <div className=" relative">
                <img src={ `https://www.evokepump.com/Tpl/Home/Public/images/contact_banner.jpg` ||banner} className=" bg-cover w-full" alt="" />
            ...
            {/* <div className='text-center mt-10'>
                <p className='text-3xl md:text-5xl font-semibold'>  <span className='text-orange-500'>Contact</span>  </p>
            </div> */}
            ...
            <div className=" md:max-w-[1340px] mx-auto py-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="bg-white rounded shadow p-8 flex flex-col items-center">
                        ...
                        <div className="text-gray-500 text-center">info@libertypump.com</div>
                    </div>
                </div>
