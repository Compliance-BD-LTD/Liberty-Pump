    ...
    return (
        <div className="relative md:-mt-[50px] ">
...

                            {
                                ...
                                banners.length > 1 ?
                                    banners.map((item, index) => { 
                                        ...
                                        return (
                                            <div className="w-full bg-gray-100 md:h-screen overflow-hidden " key={index}>
                                    ...
                                    [1, 2].map((item, index) => {
                                        return (
                                            <div className="w-full bg-gray-100 md:h-screen overflow-hidden " key={index}>
                                                <img src={`https://www.evokepump.com/upload/banner/20240911/66e0eda3d62e5.jpg` || banners[0].imageUrl[0]} className="w-full h-full    " alt="" />
                                            </div>
                                        )
                                    })
            ...
            {/* <div className="text-left w-3/4 text-black  md:w-[650px] md:space-y-5 absolute md:top-2/3 left-1/2 max-sm:bottom-0 md:left-1/3 transform -translate-x-1/2  -translate-y-1/2">
                <h1 data-aos='fade-right' data-aos-duration='1000' className="md:text-4xl md:text-gray-800 text-orange-500 text-xl font-bold "> <span className="max-sm:hidden ">Welcome to</span>  <span className="text-orange-500">Liberty</span>   <span className="text-orange-500">Air</span> <br /> <span className="text-orange-500">Wheel</span></h1>
                ...
                <button data-aos='fade-up' data-aos-duration='1400' className="hidden font-semibold text-white hover:bg-orange-500 transition-all duration-300 cursor-pointer px-10 py-3 rounded-l-full rounded-r-full border-2 border-orange-500">Get Started</button>
            </div> */}
        </div>
