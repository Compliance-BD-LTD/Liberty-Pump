...
export const About = () => {
    ...
    return (
        <div className="bg-orange-500[55px]">
            <div className=" relative w-full  bg-gray-100 h-[500px]  -mt-[55px] overflow-hidden " >
                <img src={banner} className="brightness-110 max-sm:object-cover   md:h-auto  h-[500px]" alt="" />
