...
export const AllProducts = () => {
    ...
    return (
        ...
        <section  {
            ...
            <div className={` md:h-[550px] w-full overflow-hidden ${location.pathname.startsWith('/dashboard') ? `mt-0` : `md:-mt-20`}    bg-orange-500 `}>
...

                            {
                                ...
                                (
                                    <div key={index} className='flex justify-between cursor-pointer'>
                                        ...
                                        <input type="checkbox" value={item?.name.toLowerCase()} onChange={handleCheck} className='toggle toggle-sm checked:text-orange-500 checked:border-orange-500 ' />
                                    </div>
                                ))
                            }
                                    ...
                                    <section className={`w-80/100 border-2 border-gray-200  transition-all duration-300 ease-in-out transform md:hidden  space-y-3 p-4 rounded-md shadow-lg my-5  ${showFilter ? `opacity-100 scale-100` : `opacity-0 scale-95 hidden`}`}>
                                        {
                                            ...
                                            (
                                                <div key={index} className='flex justify-between cursor-pointer'>
                                                    ...
                                                    <label className='font-semibold text-cyan-700'>{capitalizeWords(item?.name)}</label>
                                                    <input type="checkbox" value={item?.name} onChange={handleCheck} className='toggle toggle-sm checked:text-cyan-600 checked:border-orange-500 ' />
                                                </div>
                                            ))
                                        }
