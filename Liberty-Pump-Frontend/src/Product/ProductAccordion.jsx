  ...
  return (
    <div className="border border-gray-300 rounded-md max-w-2xl  bg-white">
      ...
      <div className="py-8 flex justify-start px-5">
        <button onClick={handleModal} className="bg-orange-500 cursor-pointer hover:bg-cyan-600 text-white text-lg font-semibold rounded-full px-10 py-3 flex items-center gap-2 transition">
