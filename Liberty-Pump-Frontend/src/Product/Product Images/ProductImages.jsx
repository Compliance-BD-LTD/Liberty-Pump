        ...
        <div className="flex w-full flex-col items-center">
            ...
            <div className="relative w-full flex flex-col items-center mb-2">
                ...
                <button
                    ...
                    className="absolute left-2 top-1/2 -translate-y-1/2 bg-orange-500  bg-opacity-70 hover:bg-opacity-100 shadow rounded-full p-2 z-5"
                >
                    <svg
                        width={24}
                        height={24}
                ...
                <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 bg-orange-500 bg-opacity-70 hover:bg-opacity-100 shadow rounded-full p-2 z-5"
                >
                    <svg
                        width={24}
                        height={24}
