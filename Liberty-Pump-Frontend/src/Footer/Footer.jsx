...
import bg from "../assets/images/Company About/Office Building.jpg"
const Footer = () => {
  const logo = useSelector((state) => state.AirWheel.logo)

  return (
    <footer className="relative w-full bg-gray-500 mt-12 overflow-hidden">
      ...
      <div
        className="absolute inset-0 z-0 bg-white/5 backdrop-blur-xs"
        aria-hidden="true"
      />
      {/* Overlay for content */}
